<template>
  <div class="page index">
    <div class="container">
      ...
      <ol>
        <li>
          Administratorem Pani/Pana danych osobowych jest Webo Maciej Zawadzki z
          siedzibą w Gliwicach, ul. Elsnera 1 lok. 7, 44-100 Gliwice,
          zarejestrowany pod numerem NIP nr 6312613626, REGON nr 382471232.
        </li>
        <li>
        ...
        <li>
          Dane osobowe podawane na stronie są traktowane jako poufne i nie są
      ...
      <ol>
        <li>
          ...
          przetwarzamy Twoje dane jak: adres e-mail, adres IP.
        </li>
        <li>
          Dane osobowe przetwarzane są zgodnie z przepisami dotyczącymi ochrony
          danych osobowych, zgodnie z wdrożoną Polityką Prywatności. w zakresie
          i celu niezbędnym do nawiązania, ukształtowania treści Umowy, zmiany
          bądź jej rozwiązania oraz prawidłowej realizacji Usług świadczonych
          drogą elektroniczną w zakresie i celu niezbędnym do wypełnienia
          uzasadnionych interesów (prawnie usprawiedliwionych celów), a
          przetwarzanie nie narusza praw i wolności osoby, której dane dotyczą.
        </li>
        <li>
          Każda osoba, której dane dotyczą (jeżeli jesteśmy ich administratorem)
        ...
        <li>
          Wdrożyliśmy pseudoanonimizację, szyfrowanie danych oraz mamy
      ...
      <ol>
        <li>
          Witryna www.webo.agency używa cookies. Są to niewielkie pliki tekstowe
          ...
          zawartych jedynie serwerowi, który je utworzył. Cookies ułatwiają więc
          korzystanie z wcześniej odwiedzonych witryn. Gromadzone informacje
          dotyczą adresu IP, typu wykorzystywanej przeglądarki, języka, rodzaju
          systemu operacyjnego, dostawcy usług internetowych, informacji o
          czasie i dacie, lokalizacji oraz informacji przesyłanych do witryny za
        ...
        <li>
          ...
          wewnątrz firmy Webo Maciej Zawadzki w celu optymalizacji działań.
        </li>
        <li>
          Na naszej witrynie wykorzystujemy następujące pliki cookies
          zewnętrznych dostawców: Google Analytics, Cloudflare, Prismic.io,
          ...
          <ol>
            ...
            <li>
              ...
              http://www.allaboutcookies.org/manage-cookies Dodatkowe dane
              osobowe, jak adres e-mail, zbierane są jedynie w miejscach, w
