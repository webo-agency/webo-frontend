<template>
  <div class="page index">
    <div class="container">
      <h1 class="mb-5 title">Polityka prywatności</h1>

      <h2>§.1 Postanowienia Ogólne</h2>
      <ol>
        <li>Administratorem Pani/Pana danych osobowych jest Webo Maciej Zawadzki z siedzibą w Gliwicach, ul. Elsnera 1 lok. 7, 44-100 Gliwice, zarejestrowany pod numerem NIP nr 6312613626, REGON nr 382471232.</li>
        <li>Ochrona danych odbywa się zgodnie z wymogami powszechnie obowiązujących przepisów prawa, a ich przechowywanie ma miejsce na zabezpieczonych serwerach.</li>
        ...
        <li>Dane osobowe podawane na stronie są traktowane jako poufne i nie są widoczne dla osób nieuprawnionych.</li>
      </ol>

      <h2>§2. Administrator Danych</h2>
      <ol>
        <li>Usługodawca jest administratorem danych swoich klientów. Oznacza to przetwarzamy Twoje dane jak: adres e-mail, adres IP.</li>
        <li>Dane osobowe przetwarzane są zgodnie z przepisami dotyczącymi ochrony danych osobowych, zgodnie z wdrożoną Polityką Prywatności. w zakresie i celu niezbędnym do nawiązania, ukształtowania treści Umowy, zmiany bądź jej rozwiązania oraz prawidłowej realizacji Usług świadczonych drogą elektroniczną w zakresie i celu niezbędnym do wypełnienia uzasadnionych interesów (prawnie usprawiedliwionych celów), a przetwarzanie nie narusza praw i wolności osoby, której dane dotyczą.</li>
        ...
        <li>Kontakt z osobą nadzorującą przetwarzanie danych osobowych w organizacji Usługodawcy jest możliwy drogą elektroniczną pod adresem e-mail: support@webo.agency.</li>
        ...
        <li>Wdrożyliśmy pseudoanonimizację, szyfrowanie danych oraz mamy wprowadzoną kontrolę dostępu dzięki czemu minimalizujemy skutki ewentualnego naruszenia bezpieczeństwa danych.</li>
      ...
      <ol>
        <li>Witryna www.webo.agency używa cookies. Są to niewielkie pliki tekstowe wysyłane przez serwer www i przechowywane przez oprogramowanie komputera przeglądarki. Kiedy przeglądarka ponownie połączy się ze stroną, witryna rozpoznaje rodzaj urządzenia, z którego łączy się użytkownik. Parametry pozwalają na odczytanie informacji w nich zawartych jedynie serwerowi, który je utworzył. Cookies ułatwiają więc korzystanie z wcześniej odwiedzonych witryn. Gromadzone informacje dotyczą adresu IP, typu wykorzystywanej przeglądarki, języka, rodzaju systemu operacyjnego, dostawcy usług internetowych, informacji o czasie i dacie, lokalizacji oraz informacji przesyłanych do witryny za pośrednictwem formularza kontaktowego.
        </li>
        <li>
        ...
        <li>
          Na naszej witrynie wykorzystujemy następujące pliki cookies zewnętrznych dostawców: Google Analytics, Cloudflare, Prismic.io, RocketChat, Messenger:
          <ol>
            <li>
