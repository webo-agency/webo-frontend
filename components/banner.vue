<template>
  ...
  >
    <div class="container">
      <div class="row">
        <div
          class="banner--wrapper col-12 col-hg-7 mx-auto my-6 d-flex flex-column text-center text-xs-left align-items-center align-items-xs-left ml-hg-0 mr-hg-auto justify-content-hg-center"
        >
          <h1
            class="banner--title decoration text-center text-hg-left m-0 ml-hg-0 mr-hg-auto"
          >
            {{ title }}
          </h1>
          <p
            class="banner--paragraph text-center text-hg-left mb-5 mx-0 ml-hg-0 mr-hg-auto"
          >
            {{ description }}
          </p>
          <button
  ...
  mounted() {
    ...
    var update = function(event) {
      ...
      updateTransformStyle(
        ((mouse.y / inner.offsetHeight / 2) * 20).toFixed(2),
        ((mouse.x / inner.offsetWidth / 2) * 20).toFixed(2)
      );
    };
